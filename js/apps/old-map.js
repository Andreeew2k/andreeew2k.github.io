document.addEventListener("DOMContentLoaded", () => {
  ...
  function makeDraggable(win) {
    ...
    document.addEventListener("mousemove", e => {
      ...
      // ✅ ensure title bar never goes above screen
  ...
  function initMap(containerId) {
    const map = L.map(win.querySelector(containerId), {
      ...
      // ✅ prevent dragging outside the visible world
      maxBounds: [
        [-90, -180], // southwest corner
        [90, 180]    // northeast corner
      ],
      maxBoundsViscosity: 1.0 // "elastic" lock at edges (1.0 = fully locked)
    });
    ...
    // ✅ Predefined pins
    // Grouped visited places with reasons and custom colors
    // Supported marker colors from leaflet-color-markers:
 ...
 // Render markers with group color and reason in popup
